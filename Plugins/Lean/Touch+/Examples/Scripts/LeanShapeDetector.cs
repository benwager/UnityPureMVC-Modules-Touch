...
namespace Lean.Touch
{
    ...
    public class LeanShapeDetector : MonoBehaviour
    {
        ...
        public FingerDataEvent OnDetected { get { if (onDetected == null) onDetected = new FingerDataEvent(); return onDetected; } }
        [SerializeField] private FingerDataEvent onDetected;
