...
namespace Lean.Touch
{
    ...
    public class LeanFingerHeld : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("onHeldDown")] [FormerlySerializedAs("OnHeldDown")] [SerializeField] private LeanFingerEvent onFingerDown;

        /// <summary>Called on every frame the conditions are met.</summary>
        public LeanFingerEvent OnFingerSet { get { if (onFingerSet == null) onFingerSet = new LeanFingerEvent(); return onFingerSet; } }
        [FormerlySerializedAs("onHeldSet")] [FormerlySerializedAs("OnHeldSet")] [SerializeField] private LeanFingerEvent onFingerSet;
        ...
        [FormerlySerializedAs("onHeldUp")] [FormerlySerializedAs("OnHeldUp")] [SerializeField] private LeanFingerEvent onFingerUp;
        ...
        public Vector3Event OnPositionDown { get { if (onPositionDown == null) onPositionDown = new Vector3Event(); return onPositionDown; } }
        [SerializeField] private Vector3Event onPositionDown;

        /// <summary>Called on the first frame the conditions are met.
        /// Vector3 = Current point based on the ScreenDepth settings.</summary>
        public Vector3Event OnPositionSet { get { if (onPositionSet == null) onPositionSet = new Vector3Event(); return onPositionSet; } }
        [SerializeField] private Vector3Event onPositionSet;

        /// <summary>Called on the first frame the conditions are met.
        /// Vector3 = End point based on the ScreenDepth settings.</summary>
        public Vector3Event OnPositionUp { get { if (onPositionUp == null) onPositionUp = new Vector3Event(); return onPositionUp; } }
        [SerializeField] private Vector3Event onPositionUp;
