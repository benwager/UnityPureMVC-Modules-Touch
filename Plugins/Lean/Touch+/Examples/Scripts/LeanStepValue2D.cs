...
namespace Lean.Touch
{
    ...
    public class LeanStepValue2D : MonoBehaviour
    {
        ...
        public Vector2Event OnStep { get { if (onStep == null) onStep = new Vector2Event(); return onStep; } }
        [FormerlySerializedAs("OnStep")] [SerializeField] private Vector2Event onStep;
