...
namespace Lean.Touch
{
    ...
    public class LeanAnySelected : MonoBehaviour
    {
        ...
        public UnityEvent OnFirstSelected { get { if (onFirstSelected == null) onFirstSelected = new UnityEvent(); return onFirstSelected; } }
        [UnityEngine.Serialization.FormerlySerializedAs("OnSelectedStart")] [SerializeField] private UnityEvent onFirstSelected;

        /// <summary>Called when all LeanSelectables are deselected.</summary>
        public UnityEvent OnLastDeselected { get { if (onLastDeselected == null) onLastDeselected = new UnityEvent(); return onLastDeselected; } }
        [UnityEngine.Serialization.FormerlySerializedAs("OnSelectedEnd")] [SerializeField] private UnityEvent onLastDeselected;
