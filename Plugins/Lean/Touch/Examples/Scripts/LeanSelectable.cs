...
namespace Lean.Touch
{
    ...
    public class LeanSelectable : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("OnSelect")] [SerializeField] private LeanFingerEvent onSelect;
        ...
        public LeanFingerEvent OnSelectSet { get { if (onSelectSet == null) onSelectSet = new LeanFingerEvent(); return onSelectSet; } }
        [FormerlySerializedAs("OnSelectSet")] [SerializeField] private LeanFingerEvent onSelectSet;
        ...
        [FormerlySerializedAs("OnSelectUp")] [SerializeField] private LeanFingerEvent onSelectUp;
        ...
        [FormerlySerializedAs("OnDeselect")] [SerializeField] private UnityEvent onDeselect;
