...
namespace Lean.Touch
{
    ...
    public abstract class LeanSwipeBase : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("onSwipe")] [FormerlySerializedAs("OnSwipe")] [SerializeField] private LeanFingerEvent onFinger;
        ...
        [FormerlySerializedAs("onDelta")] [FormerlySerializedAs("onSwipeDelta")] [FormerlySerializedAs("OnSwipeDelta")] [SerializeField] private Vector2Event onDelta;
        ...
        [FormerlySerializedAs("onSwipeFromTo")] [SerializeField] private Vector3Vector3Event onWorldFromTo;
