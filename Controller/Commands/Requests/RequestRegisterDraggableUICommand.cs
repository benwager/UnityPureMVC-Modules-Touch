...
{
    internal class RequestRegisterDraggableUICommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            touchProxy.TouchEngineComponent.RegisterDraggableUI(registerTouchVO.gameObject, registerTouchVO.includeChildren, registerTouchVO.callback);
        }
    }
}
