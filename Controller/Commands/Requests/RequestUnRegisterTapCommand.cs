...
{
    internal class RequestUnRegisterTapCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            touchProxy.TouchEngineComponent.UnRegisterTap(registerTouchVO.gameObject, registerTouchVO.callback);
        }
    }
}
